...
<section class="page_title_sec">
	<div class="container">
		<div class="page_title"><h1>Directory Listing</h1></div>
	</div>
</section><!-- /page_title -->
					...
					<div class="table-responsive">
						<table class="table">
							...
							<tbody>
								...
								$total = count(get_directory_items( get_region(), $posts_per_page, 0, true ));

								$offset = ($paged > 0) ? (($paged - 1) * $posts_per_page) : 0;

								$users = get_directory_items( get_region(), $posts_per_page, $offset );
								// var_dump($users);
								if($users):
