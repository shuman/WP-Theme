<?php
/**
 * Template Name: Directory Underwriter Listing
 */
get_header();
?>
<section class="page_title_sec">
	<div class="container">
		<div class="page_title"><h1>Underwriter Directory</h1></div>
	</div>
</section><!-- /page_title -->
					...
					<div class="table-responsive">
						<table class="table">
							...
							<tbody>
								...
								$total = count(get_directory_items( get_region(), $posts_per_page, 0, true, "Underwriters" ));

								$offset = ($paged > 0) ? (($paged - 1) * $posts_per_page) : 0;

								$users = get_directory_items( get_region(), $posts_per_page, $offset, false, "Underwriters");
								// var_dump($users);
