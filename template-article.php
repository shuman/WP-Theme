				...
				<div class="blog_content">
					...
					?>
						<?php if ( have_posts() ) : ?>
							...
							<div class="post_title"><h2>Community articles</h2></div><!-- /post_title -->
							<div class="blog_post">
								<?php while ( have_posts() ) : the_post(); 

									$img_url = get_template_directory_uri() . '/images/article_default.png';
								 ...
								 ?>
									<div class="post_item">
										<div class="resch_pic"><img src="<?php echo $img_url;?>"></div>
										<div class="post_desc">
